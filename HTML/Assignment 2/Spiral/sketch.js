...
function setup() {
  ...
  sliders(3, 7, 30, 6, "yellow"); // Calling the sliders-function. It creates the slider/picker-elements. Passing the std-values.
}
...
function draw() {
  ...
  if (!fullscreen()) {
    ...
    text("Spiral", 20, 20, 200, 20); // Title
    ...
    stroke(0);
    textSize(14);
    text("Number of spirals: " + slider1.value(), 20, 60, 200, 20); // Label for slider 1
    text("Number of turns: " + slider2.value(), 20, 120, 200, 20); // Label for slider 2
    text("Speed: " + slider3.value() + "%", 20, 180, 200, 20); // Label for slider 3
    text("Thickness: " + slider4.value(), 20, 240, 200, 20); // Label for slider 4
